...
export default function DashboardPage() {
  ...
  /**
   * Helper: retrieveToken (Reused bridge from Phase 2)
   */
   ...
   * Fetches the official ledger from the API Gateway.
   */
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] p-6 lg:p-16 space-y-12" data-component="InvestorDashboard">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        {/* Left Column: Server-Calculated Score */}
        ...
        {/* Right Column: Postgres-backed Asset Grid */}
        <section className="lg:col-span-8 space-y-8">
          <div className="flex flex-col sm:flex-row justify-between items-center bg-emerald-950 px-10 py-10 rounded-[3rem] shadow-2xl text-left gap-6 border border-emerald-800">
            <div className="flex items-center gap-6">
               <div className="w-14 h-14 bg-white/10 rounded-[1.25rem] flex items-center justify-center text-emerald-400 shadow-inner"><PortfolioIcon size={28} /></div>
               <div>
